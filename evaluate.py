...
CKPT_FILE = "./checkpoint-OID/yolov3.ckpt-20000"
IOU_THRESH = 0.5
SCORE_THRESH = 0.3
...
test_tfrecord = "data/OID/tfrecords/test/data.tfrecord"
...
try:
    ...
    while True:
        ...
        pred_boxes, pred_scores, pred_labels, _ = utils.cpu_nms(pred_boxes, pred_confs * pred_probs, pred_probs,
                                                                NUM_CLASSES,
